...
```
Podemos observar que la curva de densidad de los varones está corrida hacia la derecha con respecto a la curva de la densidad conjunta, lo que indica valores en general más grandes. La curva de las mujeres está desplazada hacia la izquierda con respecto a la curva de densidad conjunta. Podemos concluir que, en general, el perímetro cefálico de los varones es mayor que el de las mujeres.
